...
export const WalletIcon: React.FC<IconSvgProps> = ({
  ...
  <svg width={size || width} height={size || height} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1" />
    <path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4" />
  </svg>
)

export const BanknoteArrowUpIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-white" }) => (
  <BanknoteArrowUp className={className} strokeWidth={2.5} />
);

export const BanknoteArrowDownIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-white" }) => (
  <BanknoteArrowDown className={className} strokeWidth={2.5} />
);

export const PiggyBankIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-white" }) => (
  <PiggyBank className={className} strokeWidth={2.5} />
);

export const CreditCardIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-white" }) => (
  <CreditCard className={className} strokeWidth={2.5} />
);
...
export const SparklesIcon: React.FC<IconSvgProps> = ({
  ...
  <svg width={size || width} height={size || height} viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M20 2v4" stroke="url(#sparkles-gradient)" />
    <path d="M22 4h-4" stroke="url(#sparkles-gradient)" />
    <circle cx="4" cy="20" r="2" stroke="url(#sparkles-gradient)" />
  </svg>
);
